...
public class ImovelBDHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<Imovel> getAllImoveisBD(){
        ...
        if (cursor.moveToFirst()){
            do{
                Imovel auxImovel = new Imovel(cursor.getInt(0), cursor.getInt(1), cursor.getInt(2), cursor.getInt(3), cursor.getInt(4), cursor.getInt(5), cursor.getDouble(6),
                        cursor.getString(7), cursor.getString(8), cursor.getString(9), cursor.getString(10), cursor.getString(11), cursor.getInt(12), cursor.getString(13), cursor.getString(14));
